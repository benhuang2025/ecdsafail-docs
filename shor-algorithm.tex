...
\textbf{much of the optimization history of this circuit has been the optimization history of the modular inverse (GCD)}---though, as noted below, the surrounding field arithmetic still yields wins too. There are four reasons the GCD dominates, and they compound:
...
\medskip
In a word: minimizing $\text{Toffoli}\times\text{qubit}$ is, to first order, reducing the cost of the modular inverse---the GCD is the \textbf{largest cost
